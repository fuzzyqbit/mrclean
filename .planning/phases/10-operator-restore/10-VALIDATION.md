...
| 10-05-T2 | 10-05 | 2 | REVMODE-08 | T-10-05-02/04/05 | Degrade matrix: map missing/corrupt/truncated/garbage-key/chmod-000/unknown-sid → output==input, constant-shape warning, exit 0, no litter/mtime; lock-held row (g): proper-lockfile held on seeded map → runRestore completes lock-free without hang/contention, correct restored output, lock intact (SC3 'locked' direct evidence) | unit | `npx vitest run tests/restore/degrade.test.ts --project=unit` | ❌ W0 | ⬜ pending |
